...
import type { UserRequestSchema, UserResponseSchema, Body_upload_files_uploadfiles_post } from './models';
...
export type TDataUploadFilesUploadfilesPost = {
  formData: Body_upload_files_uploadfiles_post;
};
...
export class LoginService {
   ...
   * @throws ApiError
   */
  public static healthHealthGet(): CancelablePromise<boolean> {
    return __request(OpenAPI, {
      method: 'GET',
      url: '/health',
    });
   ...
   * @throws ApiError
   */
  public static modelsModelsGet(): CancelablePromise<unknown> {
    return __request(OpenAPI, {
      method: 'GET',
      url: '/models',
    });
